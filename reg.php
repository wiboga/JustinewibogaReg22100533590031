...
/*Passing form data into php variable*/
 ...
 $qry="insert into reg values('','$n','$sn','$e','$c','$cn','$f','$p','$r')";
 /*Executing SQL query*/
...
<td bgcolor="#000000" style="font-size:60px;color:yellow;font-variant:small-caps;font-family:arial;text-shadow:4px 4px 4px white" align="center">
